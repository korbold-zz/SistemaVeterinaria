...
/* Created on:     03/02/2015 10:50:52                          */
/*==============================================================*/
...
create table TAB_CONTROL_MASCOTA (
   ID_CONTROL_DE_MASCOTA integrer             not null,
   ID_FICHA_INGRESO     integer              null,
   TIPO_DE_CONTROL      varchar(10)          null,
...
create table TAB_MEDICAMENTOS_SUMINISTRADOS (
   ID_MEDIACAMENTO_SUMINISTRADO integer              not null,
   ID_MEDICAMENTO       integer              null,
   ID_FICHA_INGRESO     integer              null,
   FECHA_SUMINISTRO     datetime             null,
...
create table TAB_PERSONA (
   ...
   DIRECCION_NUMERO     varchar(10)          null,
...
create table TAB_SALIDA_DE_MASCOTA (
   ID_FICHA_INGRESO     integer              not null,
   FECHA_DE_ALTA        varchar(10)          null,
   ESTADO               varchar(10)          null,
   OBSERVACION          varchar(10)          null,
   CITA                 varchar(10)          null,
...
create table TAB_TIPO_DE_MASCOTA (
   ...
   TIPO_DE_MASCOTA      varchar(10)          null,
...
create table TAB_USUARIOS (
   ...
   ID_ROL               integer              null,
   ID_PERSONA           integer              null,
   NOMBRE_USUARIO       varbinary(30)        null,
   CLAVE                varbinary(30)        null,
